...
export const accessories: Accessory[] = [
  ...
  {
    id: 701,
    name: 'Легендарный щит Тора',
    slot: 6,
    slotName: 'Спина',
    description: 'Щит бога грома с жёлтыми характеристиками',
    rarity: 'legendary',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, defense: 3, damage: 3, maxHp: 20, maxArmor: 20 },
    accessoryType: 'defense',
    imageUrl: captainShieldImg,
    isYellowOnly: true,
  },
  {
    ...
    slot: 6,
    slotName: 'Спина',
    description: 'Клинок из чистой энергии',
    rarity: 'epic',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, damage: 4, luck: 2, fireRate: 5 },
    accessoryType: 'attack',
    imageUrl: iceSwordImg,
    isYellowOnly: true,
  },
  {
    ...
    slot: 6,
    slotName: 'Спина',
    description: 'Топор, усиленный магией',
    rarity: 'rare',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, damage: 2, luck: 1, maxHp: 10 },
    accessoryType: 'attack',
    imageUrl: magmaAxeImg,
    isYellowOnly: true,
  },
  {
    ...
    slot: 6,
    slotName: 'Спина',
    description: 'Энергетический барьер для защиты',
    rarity: 'epic',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, defense: 2, maxArmor: 15, reflect: 3 },
    accessoryType: 'defense',
    imageUrl: energyShieldImg,
    isYellowOnly: true,
  },
  {
    ...
    slot: 6,
    slotName: 'Спина',
    description: 'Мощный боевой молот',
    rarity: 'rare',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, damage: 2, stunChance: 3, maxHp: 8 },
    accessoryType: 'attack',
    imageUrl: jayceHammerImg,
    isYellowOnly: true,
  },
  {
    ...
    slot: 6,
    slotName: 'Спина',
    description: 'Древний русский оберег',
    rarity: 'epic',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, defense: 2, maxArmor: 12, antiStun: 5 },
    accessoryType: 'defense',
    imageUrl: russianAxeImg,
    isYellowOnly: true,
  },
  {
    ...
    slot: 6,
    slotName: 'Спина',
    description: 'Молот легендарной силы',
    rarity: 'legendary',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, damage: 5, luck: 3, maxHp: 15, fireRate: 8 },
    accessoryType: 'attack',
    imageUrl: thorHammerImg,
    isYellowOnly: true,
  },
  {
    id: 708,
    name: 'Бейсбольная бита силы',
    slot: 6,
    slotName: 'Спина',
    description: 'Усиленная бейсбольная бита',
    rarity: 'rare',
    stats: { ...emptyStats },
    yellowStats: { ...emptyStats, damage: 1, stunChance: 4, maxHp: 5 },
    accessoryType: 'attack',
    imageUrl: comptonBatImg,
    isYellowOnly: true,
  },
